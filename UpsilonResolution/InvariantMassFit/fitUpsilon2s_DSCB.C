...
void fitUpsilon2s_DSCB(const char* infileName = "../Files/Q1_Upsilon2SMass.root"){
   ...
   // Y(2S) signal shape
	RooRealVar mean_1S("mean_1S", "mean 1S", PDGmass_2S, 9.9, 10.2);
   ...
   // get the tail parameters of the signal shape first in case the MC fit is needed
	...
	cFit -> SaveAs("./Graphs/Upsilon2SFit_DSCB.png");
}